...
class FunctionalTests(unittest.TestCase):
    ...
    def test_validate_customer_name(self):
        ...
        try:
            ...
            # Explicitly check if result is True, None should make this fail
            self.assertTrue(result is True, "validate_customer should return True for valid names")
            self.test_utils.yakshaAssert("test_validate_customer_name", result is True, "functional")
